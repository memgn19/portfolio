        ...
        <div className="space-y-8 ">
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-lg animate-fade-in animation-delay-200">
              Hi 👋, I'm Elena Moreno a passionate programmer from Colombia. ✨
              I love creating aesthetic and functional web experiences. I
              specialize in React for dynamic interfaces, and also have
              experience with C# and PHP. I enjoy designing efficient, scalable
              databases to support strong applications. ✨
            </p>
          </div>
          ...
          <div className="flex items-center gap-2 animate-fade-in animation-delay-400">
            ...
            {[
              { icon: Github, href: "https://github.com/memgn19" },
              {
                icon: Linkedin,
                href: "https://www.linkedin.com/in/elena-moreno-a63197293/",
              },
            ].map((social, index) => (
              <a
                key={index}
